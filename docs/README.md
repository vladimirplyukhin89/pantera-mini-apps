...
Веб-приложение боксёрского клуба Pantera — Telegram Mini App с лендингом, галереей, событиями и страницей спортсменов. Контент управляется через Strapi CMS.
